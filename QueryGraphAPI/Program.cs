...
namespace QueryGraphAPI
{
    class Program
    {
        ...
        private static void PrintCommands()
        {
            Console.ResetColor();
            Console.WriteLine();
            Console.Write("Welcome to LearnSmartCoding. Visit https://learnsmartcoding.com/ for more details.");
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine("Topic: Querying Azure Active Directory B2C using Graph API");
            Console.WriteLine();
